    ...
    <div className="flex gap-1 p-2 pr-9 border-b-[1px] border-gray-200">
      ...
      <div className="flex-1 flex flex-col">
        <textarea
          ...
          className="h-10 text-md placeholder:font-semibold placeholder-gray-400 align-middle px-2 flex items-center resize-none mb-2 bg-inherit py-2 scrollbar-hide outline-none"
        />
        <hr />
        <div className="flex justify-between items-center mt-2">
          <div className="flex gap-1 [&_svg]:w-7 [&_svg]:cursor-pointer [&_div]:rounded-full [&_div]:p-0.5">
            <div className="hover:bg-[#E3F2FD]">
              <svg
                viewBox="-2 -2 28 28"
                fill="none"
          ...
          <button className="w-16 leading-5 font-semibold bg-[#1DA1F2] text-white text-xs py-1 rounded-full hover:bg-[rgb(26,140,216)]">
            Tweet
          </button>
        </div>
      </div>
